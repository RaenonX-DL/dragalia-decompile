...
{
	internal class MiiBridgeMapper : BaseMapper<Mii>
	{
		// Fields
		private static readonly string[] MANDATORY_FIELDS;
	
		// Constructors
		public MiiBridgeMapper();
		static MiiBridgeMapper();
	
		// Methods
		public override Mii FromDictionary(IDictionary<string, object> jsonObject);
	}
}
