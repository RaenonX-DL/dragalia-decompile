...
{
	public class SubscriptionTransactionMapper : BaseMapper<SubscriptionTransaction>
	{
		// Fields
		...
		static SubscriptionTransactionMapper();
	
		// Methods
		public override SubscriptionTransaction FromDictionary(IDictionary<string, object> jsonObject);
	}
}
