...
namespace Gluon
{
	public class BoxSummonPage : EventQuestPageBase
	{
		...
		private sealed class __c
		{
			...
			public static Comparison<AtgenBoxSummonDetail> __9__24_0;
			public static Func<BoxSummonDataElement, bool> __9__27_0;
			public static Action<PageBase> __9__30_2;
			...
			// Methods
			internal int _SetupSummonData_b__24_0(AtgenBoxSummonDetail a, AtgenBoxSummonDetail b);
			internal bool _SetupPointCost_b__27_0(BoxSummonDataElement item);
			internal void _OnSummonButtonTouched_b__30_2(PageBase nextPage);
		}
	
		[CompilerGenerated]
		private sealed class _WaitForSetupContents_d__33 : IEnumerator<object>
		{
			// Fields
			...
			// Constructors
			[DebuggerHidden]
			public _WaitForSetupContents_d__33(int __1__state);
		...
		[CompilerGenerated]
		private void _Start_b__19_0();
		[CompilerGenerated]
		private void _OnSummonButtonTouched_b__30_0(bool execDemo);
		[CompilerGenerated]
		private void _OnSummonButtonTouched_b__30_1();
		[CompilerGenerated]
		private bool _WaitForSetupContents_b__33_0();
		[CompilerGenerated]
		[DebuggerHidden]
