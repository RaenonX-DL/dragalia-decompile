...
{
	[RequireComponent]
	public class SummonPageScrollViewRect : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler, IPointerDownHandler, IPointerUpHandler
	{
		// Fields
		[SerializeField]
		...
		{
			// Fields
			public SummonPageScrollViewRect __4__this;
			public float dstX;
		...
		// Constructors
		public SummonPageScrollViewRect();
