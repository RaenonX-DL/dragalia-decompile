...
namespace Gluon.Master
{
	...
	public class MissionDailyDataElement : IMasterElement
	{
		...
		public string LockReceiveRewardEndDate { get; }
		public MissionLockRewardType LockReceiveRewardType { get; }
		public int LockReceiveRewardParam { get; }
		public int IsPickup { get; }
		public int BlankViewQuestStoryId { get; }
		public int BlankViewQuestId { get; }
	
		// Constructors
		public MissionDailyDataElement();
	}
}
