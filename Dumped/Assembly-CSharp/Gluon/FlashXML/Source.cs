...
namespace Gluon.FlashXML
{
	...
	public class Source
	{
		// Fields
		[CompilerGenerated]
		private Point _point_k__BackingField;
		[CompilerGenerated]
		private float _frameRate_k__BackingField;
		[CompilerGenerated]
		...
		// Properties
		[XmlElement]
		public Point point { [CompilerGenerated] get; [CompilerGenerated] set; }
		[XmlAttribute]
		public float frameRate { [CompilerGenerated] get; [CompilerGenerated] set; }
		[XmlAttribute]
