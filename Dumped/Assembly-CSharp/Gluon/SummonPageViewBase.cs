...
namespace Gluon
{
	public class SummonPageViewBase : MonoBehaviour
	{
		...
		[CompilerGenerated]
		private void _Start_b__65_0(int x);
		[CompilerGenerated]
		private void _Start_b__65_1(Vector2 x);
		[CompilerGenerated]
		private void _CreatePager_b__85_0(int index);
		[CompilerGenerated]
		private void _SetPageArrow_b__93_0();
		[CompilerGenerated]
		private void _SetPageArrow_b__93_1();
	}
}
