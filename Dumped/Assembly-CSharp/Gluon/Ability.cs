...
namespace Gluon
{
	public class Ability : AbilityBase
	{
		...
		public static float GetValue(AbilityDataElement ade, int idx);
		...
		private void AddConditionallyAbilityList(AbilityDataElement ade, AbilityConst.UnitType unitType, int unitId);
		private void MixBuffAbility(AbilityConst.UnitType unitType);
		public void CheckConditionallyAbility(CharacterBase owner, CharacterBase from, AbilityCondition conditionType, int actionId, int skillIndex = 0, int conditionValue = 0, int skillId = 0, int requiredActionConditionId = 0, CharacterBase hostile = null, int conditionValue2 = 0);
