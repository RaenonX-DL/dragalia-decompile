...
namespace Gluon
{
	public class EventNextPreviewPopup : PopupBase
	{
		...
		[CompilerGenerated]
		private sealed class _PlayVoiceCoroutine_d__17 : IEnumerator<object>
		{
			// Fields
			...
			// Constructors
			[DebuggerHidden]
			public _PlayVoiceCoroutine_d__17(int __1__state);
		...
		// Methods
		public static EventNextPreviewPopup Create(EventDataElement eventData, Transform parentTransform = null);
		...
		[CompilerGenerated]
		private void _Start_b__15_0(GameObject page, int index);
	}
}
