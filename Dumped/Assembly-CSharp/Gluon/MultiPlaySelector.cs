...
namespace Gluon
{
	public class MultiPlaySelector : MonoBehaviour
	{
		...
		[CompilerGenerated]
		private sealed class _SetElementTextWithIconImage_d__49 : IEnumerator<object>
		{
			// Fields
			...
			// Constructors
			[DebuggerHidden]
			public _SetElementTextWithIconImage_d__49(int __1__state);
		...
		private IEnumerator SetElementTextWithIconImage(string orgStr, Image icon, UnityEngine.UI.Text iconInText);
		...
		[CompilerGenerated]
		private void _Update_b__38_1(bool retry);
		[CompilerGenerated]
		private void _OnGuildButtonPressed_b__44_0();
		[CompilerGenerated]
