...
namespace Cute.Cri
{
	public class AtomExCategoryController : VolumeControllerBase
	{
		...
		{
			// Fields
			public AtomExCategoryController __4__this;
			public SoundGroup soundGroup;
		...
		// Constructors
		public AtomExCategoryController();
	
		// Methods
		public override void RelateSoundGroup(SoundGroup soundGroup, params string[] atomCategoryNameArray);
