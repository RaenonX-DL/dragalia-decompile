...
namespace DG.Tweening
{
	public static class ShortcutExtensions
	{
		...
		private sealed class __c__DisplayClass34_0
		{
			...
			internal Vector3 _DOJump_b__1();
			internal Vector3 _DOJump_b__2();
			internal void _DOJump_b__3();
		}
		...
		private sealed class __c__DisplayClass68_0
		{
			...
			internal Vector3 _DOJump_b__2();
			internal void _DOJump_b__3(Vector3 x);
			internal Vector3 _DOJump_b__4();
			internal void _DOJump_b__5(Vector3 x);
			internal void _DOJump_b__6();
		}
		...
		private sealed class __c__DisplayClass69_0
		{
			...
			internal Vector3 _DOLocalJump_b__2();
			internal void _DOLocalJump_b__3(Vector3 x);
			internal Vector3 _DOLocalJump_b__4();
			internal void _DOLocalJump_b__5(Vector3 x);
			internal void _DOLocalJump_b__6();
		}
		...
		private sealed class __c__DisplayClass74_0
		{
			...
			// Methods
			internal float _DOTimeScale_b__0();
			internal void _DOTimeScale_b__1(float x);
		}
		...
		private sealed class __c__DisplayClass82_0
		{
			...
			// Methods
			internal Vector3 _DOBlendablePunchRotation_b__0();
			internal void _DOBlendablePunchRotation_b__1(Vector3 v);
		}
		...
		public static Tweener DOLookAt(this Rigidbody target, Vector3 towards, float duration, AxisConstraint axisConstraint = AxisConstraint.None, Vector3? up = default);
		...
		public static Tweener DOLookAt(this Transform target, Vector3 towards, float duration, AxisConstraint axisConstraint = AxisConstraint.None, Vector3? up = default);
		...
		public static TweenerCore<Vector3, Path, PathOptions> DOPath(this Transform target, Vector3[] path, float duration, PathType pathType = PathType.Linear, PathMode pathMode = PathMode.Full3D, int resolution = 10, Color? gizmoColor = default);
		public static TweenerCore<Vector3, Path, PathOptions> DOLocalPath(this Transform target, Vector3[] path, float duration, PathType pathType = PathType.Linear, PathMode pathMode = PathMode.Full3D, int resolution = 10, Color? gizmoColor = default);
